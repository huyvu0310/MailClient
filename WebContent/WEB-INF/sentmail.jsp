            ...
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case">Sent mails(${numberMsg})
                    ...
                    <div style="margin-left:20px; color:blue;">${msg}</div>
                    <div class="panel-body minimal">
						...
						%>
			          					<tr>
				                            <td class="view-message  dont-show"  style="width:20%;"><a href="#"><%=msg.getTo()%></a></td>
				                            <td class="view-message " style="width:40%;"><a href="<%=request.getContextPath()%>/detail?idSent=<%=msg.getId()-1%>"><%=msg.getSubject()%></a></td>
