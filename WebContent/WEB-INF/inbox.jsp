                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-pills nav-stacked mail-nav">
                            <li class="active"><a href="<%=request.getContextPath()%>/inbox"> <i class="fa fa-inbox"></i> Inbox  
                            	<%
            ...
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case">Inbox (${numberMsg})
                    ...
                    <div class="panel-body minimal">
						...
						%>
			          					<tr onclick="">
				                            <td class="view-message  dont-show"  style="width:20%;"><a href="#"><%=msg.getFrom()%></a></td>
				                            <td class="view-message " style="width:40%;"><a href="<%=request.getContextPath()%>/detail?idInbox=<%=msg.getId()%>"><%=msg.getSubject()%></a></td>
