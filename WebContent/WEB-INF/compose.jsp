                        ...
                        <div class="compose-mail">
                            <form role="form-horizontal" method="post" action="<%=request.getContextPath()%>/compose">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" tabindex="1" id="to" class="form-control" name="to" <%if(!"".equals(m.getTo())){
                                    	out.print("value='"+m.getTo()+"'");
                                    } %>>
                                ...
                                <div class="form-group hidden">
                                    ...
                                    <input type="text" tabindex="2" id="cc" class="form-control" name="cc"<%if(!"".equals(m.getCc())){
                                    	out.print("value='"+m.getCc()+"'");
                                    } %>>
                                </div>

                                <div class="form-group hidden">
                                    <label for="bcc" class="">Bcc: </label>
                                    <input type="text" tabindex="2" id="bcc" class="form-control" name="bcc"<%if(!"".equals(m.getBcc())){
                                    	out.print("value='"+m.getBcc()+"'");
                                    } %>>
                                </div>

                                <div class="form-group">
                                    <label for="subject" class="">Subject: </label>
                                    <input type="text" tabindex="1" id="subject" class="form-control" name="subject"<%if(!"".equals(m.getSubject())){
                                    	out.print("value='"+m.getSubject()+"'");
                                    } %>>
                                </div>

                                <div class="compose-editor">
                                    <textarea class="wysihtml5 form-control" rows="9" name="content">
                                ...
                                <div class="form-group">
                                    <label for="to" class="">To:</label>
                                    <input type="text" tabindex="1" id="to" class="form-control" name="to">
